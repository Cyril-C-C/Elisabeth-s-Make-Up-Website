...
Ea:["ytp-miniplayer-close-button","ytp-button"],U:{"aria-label":"Close"},S:[g.rL()]});g.J(this,a);a.Ba(this.Ny.element);this.N(a.element,"click",this.wi);a=new g.V({D:"button",Ea:["ytp-miniplayer-replay-button","ytp-button"],U:{"aria-label":"Close"},S:[g.wL()]});g.J(this,a);a.Ba(this.Ny.element);this.N(a.element,"click",this.ZT);this.N(this.player,"presentingplayerstatechange",this.Ic);this.N(this.player,"appresize",this.tb);this.N(this.player,"fullscreentoggled",this.tb);this.tb()};
